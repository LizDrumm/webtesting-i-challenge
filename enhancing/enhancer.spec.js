...
describe('repair method', () => {
    const testItem = { name: 'console', durability: 5, enhancement: 15 } 
    ...
    it('returns obj with correct key value pairs', () =>{
        expect(repairOutput).toHaveProperty('name', 'console')
...
describe('success method', () => {
    ...
    it('does not increase if enhancement at 20', () => {
        const testItem = { name: 'console', durability: 5, enhancement: 20 }
...
describe('failure method', () => {
    const testItem1 = { name: 'console', durability: 5, enhancement: 14 } 
    const testItem2 = { name: 'console', durability: 5, enhancement: 15 } 
    const testItem3 = { name: 'console', durability: 5, enhancement: 17 } 
